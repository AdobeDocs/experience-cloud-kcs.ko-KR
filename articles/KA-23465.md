...
복제 큐는 AEMaaCS 고객 중 한 명의 경우 주기적으로 차단됩니다. 이 문서에서는 엔지니어링 팀이 제안하는 관리자 권한을 사용하여 UI에서 수행할 수 있는 해결 방법에 대해 설명합니다.
...
javax.jcr.NamespaceException: 알 수 없는 네임스페이스 접두사 ns22_ 예외로 인해 AEMaaCS 고객 복제 큐 중 하나가 정기적으로 차단됩니다.
...
대기열의 차단을 해제하려면 골든 게시 배포 대기열 UI에서 요청을 삭제하기만 하면 됩니다. 고객에게 아래 단계를 수행하도록 제안하십시오.
