...
한 고객이 스테이지 게시자가 제대로 작동하지 않고 이 인스턴스에 콘텐츠를 게시할 수 없으며 error.log에 다음 오류가 표시될 수 있다고 불평하고 있습니다.
...
로그의 오류는 캐싱과 관련이 없지만, 서비스 사용자가 작성자 또는 게시자의 경로 /var/discovery에 대한 올바른 권한이 없을 때 나타납니다.

추가 조사 시 고객에게 /var/discovery 경로에 대한 권한을 확인하도록 요청하는 동안 단계 게시자에 /var 아래에 &quot;discovery&quot; 폴더가 없고 누락된 컨텐츠도 많이 있다는 것을 발견했습니다.

프로덕션 게시자의 /var 폴더에 20개 이상의 하위 폴더가 있는 동안 스테이지 게시자의 /var 폴더에는 2 - &quot;replication&quot; 및 &quot;sling&quot;만 있었습니다.

프로덕션 단계에서 스테이지로 /var/구조체를 복제하고 스테이지 게시자에서 AEM을 다시 시작한 후에 문제가 해결되었습니다.
