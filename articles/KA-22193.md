...
페이지를 열 때 사용자는 &quot;<b>잘못된 요청</b>&quot;메시지가 포함된 응답
...
이러한 오류는 #LimitRequestFieldSize 및 #LimitRequestLine에 대한 값을 증가시킴으로써 극복될 수 있다

AMS/ 온프레미스:

Apache 구성 파일 - httpd.conf에서 헤더 제한을 늘릴 수 있습니다.
