---
title: "요청 헤더 필드의 크기가 서버 제한을 초과합니다."
description: "AEM에서 페이지를 열 때 \"잘못된 요청\" 오류를 해결하는 방법에 대해 알아봅니다."
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: "KCS, 크기, 요청 헤더, 초과, 서버 제한, AEM, Adobe Experience Manager, 문제 해결, AEMaaCS, Adobe Experience Manager as a Cloud Service"
...
페이지를 열면 &quot;<b>잘못된 요청</b>&quot;메시지가 포함된 응답:

&quot;<b>*요청 헤더 필드의 크기가 서버 제한을 초과합니다.</b>*&quot;
...
Apache has a default `LimitRequestLine` of *8K*. 자세한 내용은 [Apache의 핵심 기능: LimitRequestLine 지시문](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) Apache 웹 사이트에서 확인하십시오.

이 오류는 의 값을 늘리면 해결할 수 있습니다. `#LimitRequestFieldSize` 및 `#LimitRequestLine`.

<u>AMS/ 온프레미스</u>:

Apache 구성 파일에서 헤더 제한을 늘릴 수 있습니다. - `httpd.conf`.



<u>AEMaaCS용</u>:

Vhost 파일에 위의 속성을 추가하여 요청 헤더 제한을 늘리십시오.
