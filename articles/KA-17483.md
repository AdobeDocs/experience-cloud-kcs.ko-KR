...
<br><br><br><br><br> <br><br>
자세한 내용은 <b>`DispatcherLogLevel`</b> 지시문에는 `DISP_LOG_LEVEL` 표시되는 일반 값 대신  해당 코드 섹션 위에 변수 파일에 대한 include 문이 표시됩니다.  변수 파일 *`/etc/httpd/conf.d/variables/ams_default.vars`*은 우리가 다음에 보고 싶은 곳입니다.  다음은 해당 변수 파일의 내용입니다.
<br><br><br><br><br> <br><br><br><br>
...
<br><br><br><br><br> <br><br>
현재 값이 `DISP_LOG_LEVEL` 변수는 정보입니다.  추적하거나 디버깅하거나 선택한 숫자 값/수준을 조정하도록 조정할 수 있습니다.  이제 로그 수준을 제어하는 모든 위치가 자동으로 조정됩니다.
...
<br><br><br><br><br> <br><br>
이제 apache 웹 서버는 도메인이 의 경우 트래픽을 발생해야 한다는 것을 알지만 디스패처 모듈에 전달할 새 도메인 이름을 알려주어야 합니다.  먼저 새 \* 를 만듭니다.`_vhost.any` 파일 <b>`/etc/httpd/conf.dispatcher.d/vhosts/weretail_vhosts.any`</b> 그리고 해당 파일 내에 표시할 도메인 이름을 입력합니다.
<br><br><br><br><br> <br><br><br><br>

`we-retail.adobe.com`

<br><br><br><br><br> <br><br>
이제 새 팜 파일을 사용하여 새 팜 파일을 만들어야 합니다 `vhost` 시작 파일, 그리고 새 파일에 강력한 시작 파일을 복사하는 것으로 시작합니다.
<br><br><br><br><br> <br><br><br><br>
