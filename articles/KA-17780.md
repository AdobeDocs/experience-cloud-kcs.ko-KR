---
title: html을 로 가져오는 동안 오류가 발생했습니다. [!UICONTROL 이메일 디자이너]
description: 설명
solution: Campaign
product: Campaign
...
# html을 로 가져오는 동안 오류가 발생했습니다. [!UICONTROL 이메일 디자이너]

## 설명

<b>문제:</b><br><br> <br><br>HTML 파일과 이미지가 포함된 .zip 파일을 로 가져오는 동안 [!UICONTROL 이메일 디자이너] 다음 오류가 발생했습니다.<br><br> <br><br>
