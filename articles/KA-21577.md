...
1. 리액터 pom.xml에서 사용 중인 노드 버전을 찾습니다. 아래 예 = 16.14.0 `pom.xml`:<br>
...
2. 빌드에 실패한 모듈의 `package.json` 파일에 이 노드 버전을 <b>devDependencies</b>로 추가합니다. 위의 예에서는 UI Frontend입니다.<br>
