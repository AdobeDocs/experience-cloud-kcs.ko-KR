...
전체 시스템 덤프 분석의 경우 [IBM 지원 Workbench](https://www.ibm.com/support/pages/node/718131), 사용 [IBM Java용 모니터링 및 진단 도구 - 메모리 분석기 버전 1.2](http://www.ibm.com/developerworks/java/jdk/tools/memoryanalyzer/) 가 설치되어 있습니다.
<br>히스토그램 히스토그램<br>
