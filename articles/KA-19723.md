---
title: "AEM 6.1에서 6.5로 컨텐츠를 마이그레이션할 수 없음"
description: 설명
...
# AEM 6.1에서 6.5로 컨텐츠를 마이그레이션할 수 없음

## 설명 {#description}


AEM v6.1에서 v6.5로 컨텐츠 마이그레이션 중에 다음 스택 추적이 발생합니다.
...
먼저 AEM v6.3으로 마이그레이션한 다음 v6.5로 마이그레이션하십시오.
