...
- 전화번호나 텍스트 콘텐츠별로 패킷을 분리하려면 다음 설정으로 검색 기능을 사용합니다.<br>\
...
- 사용 <b>TCP 스트림 팔로우</b> 작업 중인 스트림을 분리하는 도구입니다.<br><br>    SMPP와 관련이 없는 텍스트 프로토콜에만 유용하므로 표시되는 빨간색/파란색 텍스트 창을 닫습니다.
...
스트림은 독립 PDU로 구성됩니다. 각 PDU는 명령, 상태, 시퀀스 번호 및 명령을 기반으로 한 기타 정보가 포함된 메시지입니다.
...
| --- | --- | --- | --- | --- |
| GSM7 | 0 | 160 | 152 | [GSM7 기본 문자 세트 + 확장](https://ko.wikipedia.org/wiki/GSM_03.38) (확장 문자에는 2자가 필요함) |
