---
title: '"blobId에 대한 \"InputStream을 가져오는 동안 데이터 저장소 불일치 오류가 발생했습니다\"'
description: 설명
...
1. <b>최신 CFP/SP를 설치합니다.</b>
   ...
   에서 최신 핫픽스를 찾을 수 있습니다. [Adobe 패키지 공유](https://experience.adobe.com/#/downloads/content/software-distribution/kr/aem.html).
