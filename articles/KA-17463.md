...
[&lt;- 이전: Dispatcher 플러시](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17493.html)
...
![사이트 편집기 화면의 AEM 작성 UI에 대한 드롭다운 대화 상자 메뉴](assets/aem-page-properties-drop-down.png "aem-page-properties-드롭다운")![aem 페이지 속성 대화 상자 페이지](assets/aem-page-properties.png "aem-page-properties")

#### 클래식 컨텐츠 파인더:

![AEM siteadmin classic ui 사이드 킥페이지 속성](assets/aem-page-properties-sidekick.png "aem-page-properties-sidekick")![클래식 UI 페이지 속성 대화 상자](assets/aem-page-properties-classic.png "aem-page-properties-classic")
...
![리소스에서 별칭 항목의 콘솔 스크린샷 규칙 해결](assets/vanity-resource-resolver-entry.png "vanity-resource-resolver-entry")
...
![/libs/granite/dispatcher/content/vanityUrls.html에서 렌더링된 컨텐츠의 스크린샷](assets/vanity-url-component.png "vanity-url-component")
...
[다음 -> 일반 로깅](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17914.html)