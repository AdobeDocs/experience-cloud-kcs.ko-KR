---
title: “AEM에서 Truststor를 재설정하는 방법”
description: 설명
...
# AEM에서 Truststor를 재설정하는 방법

## 설명


로그에 표시되는 Truststore 오류를 검색할 수 없습니다.
...
2. 노드 `/etc/truststore/truststore.p12`를 삭제합니다.

3. <b>[!UICONTROL 모두 저장]</b>을 클릭합니다.
