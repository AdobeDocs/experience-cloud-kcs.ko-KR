...
더 큰 주제이므로 다음을 참조하십시오 [이 문서](https://helpx.adobe.com/experience-manager/kb/optimizing-the-dispatcher-cache.html) 를 참조하십시오 [!DNL dispatcher] 캐시.
...
1. 사이트에 개인화된/다이내믹 컨텐츠가 있는 경우:
   ...
   1. 사용 [[!DNL Apache] Sling 동적 포함](https://helpx.adobe.com/experience-manager/kt/platform-repository/using/sling-dynamic-include-technical-video-setup.html) 컨텐츠가 세분화되어 다른 시간 동안 페이지의 다른 부분을 캐시할 수 있습니다.
