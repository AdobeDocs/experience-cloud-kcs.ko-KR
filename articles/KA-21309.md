---
title: '“Adobe Experience Manager: request.log 분석의 예”'
description: 설명
...
# Adobe Experience Manager: request.log 분석의 예

## 설명 {#description}


AEM request.log에는 성능 문제를 분석하는 데 소요되는 응답 시간과 같은 다양한 유용한 정보가 포함되어 있습니다. 다음은 Linux 명령(일부 외부 명령 포함)을 사용한 분석 예제의 목록입니다.
