...
<br><br> <br><br><b>문제/증상</b><br><br> 최신 버전의 ACS에서 긴 텍스트 속성에 대한 사용자 지정 리소스 변경 사항을 게시할 때 API가 업데이트되지 않습니다. 해당 속성은 UI에서 수동 또는 워크플로 조회를 통해 액세스할 수 있지만 API를 통해서는 액세스할 수 없습니다. 그 이유는 긴 텍스트 속성만 변경할 때 API를 업데이트해야 함을 인식하지 못하는 사용자 지정 리소스 게시 프로세스의 버그 때문인 것으로 확인되었습니다.
<br> <br>
