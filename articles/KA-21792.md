...
<b><u>의 GraphQL 처리 변경 <em>null</em> 값</u></b><br><br> <br><br>릴리스 2023.02.11382에서는 이전 릴리스의 잘못된 동작에 의존할 경우 애플리케이션 코드에서 예기치 않은 동작을 초래할 수 있는 GraphQL 구현이 일부 개선되었습니다. 
...
마지막 문제는 *null* 다중 값 필드의 필터 조건에 있는 값입니다. _instances를 사용하여 모드 인스턴스 적용: 0이(가) 를 포함하는 컨텐츠 조각과 일치하지 않습니다. *null* 값은 2023.02.11382 전에 해당 필드에 있지만 2023.02.11382부터 시작됩니다. 이 성상식을 사용하는 쿼리를 테스트하고 예상 결과 집합을 더 이상 반환하지 않으면 이 쿼리를 변경하는 것이 2023.02.11382.
<b>예:</b>
