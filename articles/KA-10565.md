...
keywords: KCS, 연결, Brand Portal, 복제 에이전트, JWT가 만료됨, AEM, Adobe Experience Manager, 6.2, 오류
...
<b>문제 </b>
Brand Portal과 AEM Assets 통합 구성 후 [https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html?lang=en](https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html?lang=ko),
...
1. AEM의 OS 시간을 확인합니다.
2. 시간을 유효한 시간으로 변경하거나 ntp를 사용하십시오.
