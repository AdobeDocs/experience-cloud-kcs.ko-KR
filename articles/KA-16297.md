---
title: AEM 템플릿 가져오기 [!DNL Campaign] 콘솔
description: 설명
...
# AEM 템플릿 가져오기 [!DNL Campaign] 콘솔

## 설명


문제 설명 = AEM 템플릿을 동기화할 때 [!DNL Campaign], 다음 오류가 표시됩니다.
...
AEM 서버의 campaign AEM 사용자에게 복제 권한을 부여해야 합니다.  Adobe는 읽기/쓰기/복제 권한을 [!DNL Campaign]캠페인 자산이 있는 /content/campaign 및 /content/dam 경로 아래의 AEM 사용자.
